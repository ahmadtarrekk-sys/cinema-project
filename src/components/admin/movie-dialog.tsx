            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-foreground">English Title</label>
                  <Input name="titleEn" value={formData.titleEn} onChange={handleChange} required className="bg-foreground/5 border-border" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-foreground">Arabic Title</label>
                  <Input name="titleAr" value={formData.titleAr} onChange={handleChange} required className="bg-foreground/5 border-border" dir="rtl" />
                </div>
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <textarea 
                    ...
                    required 
                    className="w-full bg-foreground/5 border border-border rounded-md p-3 text-sm focus:outline-none focus:ring-1 focus:ring-gold min-h-[100px]" 
                  />
                </div>
                <div className="space-y-2 md:col-span-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input name="genre" value={formData.genre} onChange={handleChange} required className="bg-foreground/5 border-border" placeholder="e.g., Action / Sci-Fi" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-foreground">Duration (Minutes)</label>
                  <Input type="number" name="durationMin" value={formData.durationMin} onChange={handleChange} required className="bg-foreground/5 border-border" />
                </div>
                
                <div className="space-y-2">
                  <label className="text-sm font-medium text-foreground">Release Date</label>
                  <Input type="date" name="releaseDate" value={formData.releaseDate} onChange={handleChange} required className="bg-foreground/5 border-border [color-scheme:dark]" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-foreground">Rating</label>
                  <Input name="rating" value={formData.rating} onChange={handleChange} required className="bg-foreground/5 border-border" />
                </div>

                <div className="space-y-2 md:col-span-2">
                  <label className="text-sm font-medium text-foreground">Poster URL</label>
                  <Input name="posterUrl" value={formData.posterUrl} onChange={handleChange} required className="bg-foreground/5 border-border" />
                </div>
                <div className="space-y-2 md:col-span-2">
                  <label className="text-sm font-medium text-foreground">Trailer URL (Optional)</label>
                  <Input name="trailerUrl" value={formData.trailerUrl} onChange={handleChange} className="bg-foreground/5 border-border" />
                </div>
              </div>
